<section class="pop-section hidden" id="AddNewRecords">
    <div class="action-window">
        <div class='container'>
            <div class='row'>
                <div class='col-md-12'>
                    <h4 class='app-heading'>Add New Reminder Type</h4>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label>New Reminder Type Name</label>
                            <input type="text" minlength="5" required name="crt_name" class="form-control">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Short Name</label>
                            <input type="text" required name="crt_shortname" class="form-control">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Code</label>
                        ...
                        <div class="form-group col-md-9">
                            <label>Purpose</label>
                            <input type="text" required name="crt_purpose" class="form-control">
                        </div>
