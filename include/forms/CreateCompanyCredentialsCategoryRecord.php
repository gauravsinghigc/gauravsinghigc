<section class="pop-section hidden" id="AddNewRecords">
    <div class="action-window">
        <div class='container'>
            <div class='row'>
                <div class='col-md-12'>
                    <h4 class='app-heading'>Add New Credential Category</h4>
                </div>
            </div>
            <form class="row" action="<?php echo CONTROLLER("SystemController/ConfigController.php"); ?>" method="POST">
                ...
                <div class="col-md-12 text-right">
                    <hr>
                    <button type="submit" name="SaveCredentialCategories" class="btn btn-md btn-success"><i class="fa fa-check"></i> Save Details</button>
