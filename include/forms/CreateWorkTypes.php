<section class="pop-section hidden" id="AddNewRecords">
    <div class="action-window">
        <div class='container'>
            <div class='row'>
                <div class='col-md-12'>
                    <h4 class='app-heading'>Add New Work Types</h4>
                </div>
            </div>
            <form class="row" action="<?php echo CONTROLLER("SystemController/ConfigController.php"); ?>" method="POST">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" minlength="5" required name="cwt_name" class="form-control">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <label>Desc</label>
                            <textarea name="cwt_desc" class="form-control" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 text-right">
                    <hr>
                    <button type="submit" name="SaveWorkTypeRecords" class="btn btn-md btn-success"><i class="fa fa-check"></i> Save Details</button>
